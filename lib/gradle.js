...
export async function runGradle(projectRoot, gradleArgs, timeoutMs, signal) {
...
function looksLikeAndroidModule(projectRoot) {
...
export function normalizeModule(projectRoot, value) {
...
export function buildTask(modulePath, variant) {
